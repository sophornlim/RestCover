        ...
        <div class="col-md-12">
            <div class="box">
              <div class="box-header">
                ...
                <a href="<?php echo base_url().'index.php/customer/create'; ?>" class="btn btn-primary btn-sm pull-right">Create New</a>
				<a target="_blank" href="<?php echo base_url().'index.php/customer/pdf'; ?>" class="btn btn-primary btn-sm pull-right" style="margin-right: 5px;">Create PDF</a>
				<a target="_blank" href="<?php echo base_url().'index.php/customer/excel'; ?>" class="btn btn-primary btn-sm pull-right" style="margin-right: 5px;">Create Excel</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
