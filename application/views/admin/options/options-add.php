        ...
        <div class="col-md-12">
            <div class="box box-primary">
              <div class="box-header">
                ...
                <a href="<?php echo base_url().'index.php/options'; ?>" class="btn btn-primary btn-small pull-right">Back to List</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                $attributes = array('id' => 'frm','name'=>'frm');
                  echo form_open('options/create',$attributes); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txt_option_name" class="form-control " placeholder="Option name Here..." value="" />
                    </div>
					         
					          <div class="form-group">
                        <label>Option is active :</label>
                        <input type="radio" name="txt_option_is_active" checked value="yes" /> Yes
