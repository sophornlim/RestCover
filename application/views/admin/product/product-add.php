        ...
        <div class="col-md-12">
            <div class="box box-primary">
              <div class="box-header">
                ...
                <a href="<?php echo base_url().'index.php/product'; ?>" class="btn btn-primary btn-small pull-right">Back to List</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <?php 
              ...
              <?php 
                $attributes = array('id' => 'frm','name'=>'frm');
                  ...
                  <div class="col-md-6">
					...
					<div class="form-group">
                        ...
                        <input type="text" name="txt_product_name" class="form-control " placeholder="Product name Here..." value="" />
                    </div>
					<div class="form-group">
                        <label>Product Serial No :</label>
                        <input type="text" name="txt_product_serial_no" class="form-control " placeholder="Product serial no Here..." value="" />
                    </div>
                ...
                <div class="col-md-6">
					...
					<div class="form-group">
                        ...
                        <input type="radio" name="txt_product_is_active" checked value="yes" /> Yes
