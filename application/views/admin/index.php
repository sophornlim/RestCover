    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <h3><?php echo $total_bill; ?></h3>
                  <p>Total Selling Bill</p>
                </div>
                <div class="icon">
                  <i class="ion ion-bag"></i>
                </div>
                <a href="<?php echo base_url() ?>index.php/sales" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="<?php echo base_url() ?>index.php/customer" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
        ...
        <!-- PRODUCT LIST -->
          ...
          ?>
                ...
                <div class="box-footer text-center">
                  <a href="<?php echo base_url() ?>index.php/product" class="uppercase">View All Products</a>
                </div><!-- /.box-footer -->
              </div><!-- /.box -->
      </div>
