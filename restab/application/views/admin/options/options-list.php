        ...
        <div class="col-md-12">
            <div class="box box-primary">
              <div class="box-header">
                ...
                <a href="<?php echo base_url().'index.php/options/create'; ?>" class="btn btn-primary btn-sm pull-right">Create New</a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th align="left" >Parent Option name</th>
   										<th align="left" >Option is active</th>
   										<th>Actoin</th>
                    </tr>
                  </thead>
                  <tbody>
