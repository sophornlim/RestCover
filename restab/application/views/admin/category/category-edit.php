              ...
              <?php 
                $attributes = array('id' => 'frm','name'=>'frm');
                  echo form_open_multipart('category/update/'.$this->uri->segment(3),$attributes); ?>
                        ...
                        <input type="text" name="txt_category_name" class="form-control " placeholder="Category name Here..." value="<?php echo $recored['category_name']; ?>" />
                    </div>
					         <div class="form-group">
                    ...
                    ?>       
                     <div class="form-group">
                        ...
                        <input type="radio" name="txt_category_is_active" <?php if($recored['category_is_active'] == 'yes') echo 'checked'; ?> placeholder="Category is active Here..." value="yes" /> Yes
