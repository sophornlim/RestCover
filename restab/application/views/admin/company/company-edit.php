      ...
      <div class="row">  
         <div class='col-md-12'>
          <div class='box box-success' >
                      <div class='box-header'>
                            <h3 class='box-title'>Total Tables You Want</h3>
                        </div><!-- /.box-header -->
            <div class='box-body pad'>
                ...
                <div class="col-md-6">
                                  <div class="form-group">
                                      <label>Tables</label>
                                        <input type="text" name="txttable" class="form-control " placeholder="Enter Tables Of Number..." value="<?php echo htmlspecialchars($objcompany['total_table']); ?>" />
                                    </div>
                </div>
                <div class="col-md-6">
                                  <div class="form-group">
                                      <label>Parcel Tables</label>
                                        <input type="text" name="txtparcel" class="form-control " placeholder="Enter Parcel Of Number..." value="<?php echo htmlspecialchars($objcompany['total_parcel']); ?>" />
                                    </div>
                </div>
      ...
      <div class="row">  
          ...
          <div class='box box-danger' >
            <div class='box-body pad'>
                ...
                <div class="col-md-6 " style="background: #ffffff;">
                    <label>Generate Database Backup !!!</label>
                </div>
                <div class="col-md-6 text-right">
                  <div class="form-group">
                    <button type="button" onclick="backupg();" id="babcd" class="btn btn-danger">Generate Backup</button>
                  </div>
                </div>
            </div>
          </div>
