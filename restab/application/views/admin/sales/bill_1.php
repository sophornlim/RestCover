...
// create some HTML content
	...
	<table width="100%">
			<tr align="right">
				<td height="20">[ ] Original / [ ] Duplicate</td>
			</tr>
  </table>
   
	<table width="100%" border="1"> 
			<tr align="left">
      	<td width="75%"><h1>'. $company[0]->company_name.'</h1>&nbsp;'.$company[0]->company_address.$company[0]->company_city.'<br />&nbsp;Mobile :'.$company[0]->company_phone.'</td>
				<td rowspan="2" width="25%">
					
					<table width="100%">
						
						<tr bgcolor="#CCC" align="center">
            	<td colspan="3"><h3>DEBIT MEMO</h3></td>
            </tr>
						<tr><td colspan="3"></td></tr>
						<tr>
							<td width="55%"><h3> Bill No</h3></td>
							<td width="5%">:</td>
							<td width="40%">'.$bill_number.'</td>
						</tr>
						<tr>
							<td width="55%"><h3> Date</h3></td>
							<td width="5%">:</td>
							<td width="40%">'.$bill_date.'</td>
						</tr>
						<tr>
							<td width="55%"><h3> Transport</h3></td>
							<td width="5%">:</td>
							<td width="40%"></td>
						</tr>
						<tr><td colspan="3"></td></tr>
    ...
    <table style="border:1px solid black;" width="100%">
    	<tr>
      	<td height="20" align="center"><h3>Retail Invoice </h3> </td>
			</tr>	
    </table>
    
    <table style="border:1px solid black;" width="100%" >
      <tr>
        <th style="width:7%;border:1px solid black;" align="right"><h3>Sr.</h3></th>
        <th style="width:48%;border:1px solid black;" align="left"><h3>Description</h3></th>
        
        <th style="width:11%;border:1px solid black;" align="right"><h3>Qty</h3></th>
        <th style="width:12%;border:1px solid black;" align="left"><h3>Unit</h3></th>
        <th style="width:11%;border:1px solid black;" align="right"><h3>Rate</h3></th>
        <th style="width:11%;border:1px solid black;" align="right"><h3>Amount</h3></th>
     </tr>
		 ';
    	...
    	$output .='<tr>
      	<td colspan="2"  height="20" align="right" style="border:1px solid black;">
			<table width="100%">
				<tr>
					<td align="left" width="75%">CGST NO : '.$company[0]->company_vat_no.'</td>
								<td width="5%">:</td>
				  <td align="right" width="20%">'.$company[0]->sales_tax1.'%</td>
				</tr>
				<tr>
					<td align="left">SGST NO :'. $company[0]->company_cst_no.'</td>
								<td>:</td>
				  <td align="right">'.$company[0]->sales_tax2.'%</td>
				</tr>
				<tr>
					<td align="left">IGST NO : '.$company[0]->company_gst_no.'</td>
								<td>:</td>
		...
		<td colspan="2"  height="20" align="right" style="border:1px solid black;">
			<table width="100%">
				<tr>
					<td align="left" width="75%">CGST ('.$company[0]->sales_tax1.'%)</td>
								<td width="5%">:</td>
					<td align="right" width="20%">'.$tax_total_price1.'</td>
				</tr>
				<tr>
					<td align="left">SGST ('.$company[0]->sales_tax2.'%)</td>
								<td>:</td>
					<td align="right">'.$tax_total_price2.'</td>
				</tr>
				<tr>
					<td align="left">IGST ('.$company[0]->sales_tax3.'%)</td>
								<td>:</td>
    ...
    <table border="1" width="100%">
        ...
        <td>
        	<table width="100%">
        	<tr>
          	<td align="left" height="20" width="65%"><h2>Grand Total</h2></td>
						<td style="width:5%;">:</td>
      ...
      <tr>
      	<td colspan="4"  height="20">'.strtoupper($CI->convertNum($grand_tot).' ONLY').'</td>
      </tr>
      <tr>
      	<td colspan="2" align="left">
        	<span style="font-size:15px; font-wight:bold; " >Terms & Condition :</span>
          	<ul>';
