...
// Create Excel FIle
	...
	$data[][] = " TOTAL,$total_o,".number_format($total_c,2).",".number_format($total_d,2).",".number_format($total_s,2);
				...
				$rowCount = 1;
					...
					$excel->getActiveSheet()->SetCellValue('A'.$rowCount, ' ORDER DATE ');
					$excel->getActiveSheet()->SetCellValue('B'.$rowCount, ' TOTAL ORDER ');
					$excel->getActiveSheet()->SetCellValue('C'.$rowCount, ' CASH ');
					$excel->getActiveSheet()->SetCellValue('D'.$rowCount, ' DEBIT ');
