...
<section class="content invoice">                    
    ...
    <div class="row">
        <div class="col-xs-12" style="background-color:#DEDEDE;">
            <h2 class="page-header">
                <i class="fa fa-globe"></i> <?php echo htmlspecialchars($company[0]->company_name); ?> - Sales Invoice
                <small class="pull-right">Date: <?php echo  date("d-m-Y", strtotime($order_billdt)); ?></small>
            </h2>                            
        </div><!-- /.col -->
    </div>
    <!-- info row -->
    ...
    <div class="row">
        ...
        <strong class="lead">Product Description&nbsp;&nbsp;:&nbsp;&nbsp;</strong>
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th width="25%">Product Name</th>
                        <th width="15%">Batch No.</th>
                        <th width="14%">Price (Rs.)</th>
                        <th width="10%">Qty</th>
                        
                        <th width="14%">Subtotal (Rs.)</th>
                    </tr>                                    
                </thead>
                <tbody>
				<?php 
